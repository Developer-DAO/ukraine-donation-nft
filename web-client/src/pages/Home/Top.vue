...
<template>
    <div class="px-4 pt-8 sm:pt-12 sm:px-6 lg:max-w-7xl lg:px-8 flex justify-between items-center">
        <span class="flex items-center">
            <DaoLogo class="w-16 h-16 rounded-full shadow-md" />
            <span class="ml-4 font-semibold hidden sm:inline">Developer DAO</span>
        </span>
        <div v-if="client.isConnected.value" class="flex-1 min-w-0 flex flex-col items-end space-y-1">
